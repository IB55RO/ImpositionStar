...
class CustomLayoutEditor(tk.Toplevel):
    ...
    def __init__(self, master, items, inner_w, inner_h, margin_left_pt, margin_top_pt, gap_pt, preview_scale_pct, on_save, mode=None, paired_left_w=None, paired_gutter=None):
        ...
        # === Temă mov + tipografie accentuată ===
        ...
        style.configure("Custom.TLabel", background=self.bg_color, foreground=self.text_main, font=("Montserrat", 12, "bold"))
        style.configure("Custom.TButton", padding=(14, 10), font=("Montserrat", 12, "bold"), relief="raised")
        style.configure("Custom.Primary.TButton", padding=(14, 10), font=("Montserrat", 12, "bold"),
                        background=self.accent, foreground="#FFFFFF", relief="raised")
        style.map("Custom.Primary.TButton", background=[("active", "#5A3EA0")])
...
class PreviewWindow(tk.Toplevel):
    ...
    def __init__(self, master, variants, inner_w, inner_h, preview_scale_pct, on_choose, margin_left_pt, margin_top_pt, gap_pt, mode=None, paired_left_w=None, paired_gutter=None):
        ...
        self.card_bg ="#FFFFFF"
        self.card_sel_bg = "#EEE6FF"
        self.card_border = "#C8B6E2"
        self.card_sel_border = "#6B4BB4"
        ...
        style.configure("Preview.TButton", font=("Montserrat", 12, "bold"), padding=(14, 10), relief="raised")
        style.configure("Preview.Primary.TButton", font=("Montserrat", 12, "bold"), padding=(14, 10),
                        background="#6B4BB4", foreground="#FFFFFF", relief="raised")
        style.map("Preview.Primary.TButton", background=[("active", "#5A3EA0")])
        style.configure("Preview.TLabel", background=bg_color, foreground="#1F2937", font=("Montserrat", 12, "bold"))
...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        # === Fundal global mov deschis (tema clasică) ===
        app_bg = "#D9C3F0"
        text_main = "#1F2937"
        accent = "#6B4BB4"
        accent_hover = "#5A3EA0"
        ...
        style.configure("TLabel", background=app_bg, foreground=text_main, font=("Montserrat", 12, "bold"))
        style.configure("TCheckbutton", background=app_bg, foreground=text_main, font=("Montserrat", 12, "bold"))
        style.configure("TRadiobutton", background=app_bg, foreground=text_main, font=("Montserrat", 12, "bold"))
        style.configure("TButton", padding=(16, 10), font=("Montserrat", 12, "bold"), relief="raised")
        style.configure("Primary.TButton", padding=(16, 10), font=("Montserrat", 12, "bold"),
                        background=accent, foreground="#FFFFFF", relief="raised")
        style.map("Primary.TButton", background=[("active", accent_hover)])
        style.configure("TEntry", padding=8, relief="raised", font=("Montserrat", 12, "bold"))
        style.configure("TCombobox", padding=8, relief="raised", font=("Montserrat", 12, "bold"))
...
# ---------- FINAL PDF flow ----------
    ...
    def _show_final_dialog(self, out_path, whites_summary_dict):
        ...
        lbl = tk.Label(frm, text=msg, justify="left", anchor="w", bg=TEAL, fg="#1F2937", wraplength=700, font=("Montserrat", 12, "bold"))
        lbl.pack(fill="both", expand=True)
